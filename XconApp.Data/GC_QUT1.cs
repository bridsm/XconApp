...
namespace XconApp.Data
{
    ...
    public partial class GC_QUT1
    {
        ...
        public string U_LineDesc { get; set; }
        public Nullable<decimal> U_EarlyPrice { get; set; }
        public Nullable<decimal> U_StandardPrice { get; set; }
        public Nullable<decimal> U_OnSitePrice { get; set; }
